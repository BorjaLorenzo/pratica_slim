...
<form action="<?= BASE_URL ?>usuarioModificado" method="post">
    ...
    <div class="row">
        <div class="col s4 offset-s4">
            Nombre:
            <input type="text" name="nombre" value="<?php echo e($usuario["nombre"]); ?>">
        </div>
    </div>
    <div class="row">
        <div class="col s4 offset-s4">
            Apellidos:
            <input type="text" name="apellidos" value="<?php echo e($usuario["apellidos"]); ?>">
        </div>
    </div>
    <div class="row">
        <div class="col s4 offset-s4">
            Contrasena:
            <input type="text" name="pass" value="<?php echo e($usuario["pass"]); ?>">
        </div>
    </div>
    <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\projectos\php\pratica_slim\view/modificarUsuario.blade.php ENDPATH**/ ?>