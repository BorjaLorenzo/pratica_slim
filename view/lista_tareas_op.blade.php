...
<div class="row">
    <div class="col" class="">
        <table class="highlight centered responsive-table">
            ...
            <tr>
                <td>
                    <a href="<?=BASE_URL?>realizarTarea?id_tarea={{$tarea["id"]}}&id_operario={{$id}}" class="waves-effect waves-light btn-large">Realizada</a>
                    <a href="<?=BASE_URL?>cancelarTarea?id_tarea={{$tarea["id"]}}&id_operario={{$id}}" class="waves-effect waves-light btn-large">Cancelada</a>
                </td>
                <td>{{$tarea["id"]}}</td>
